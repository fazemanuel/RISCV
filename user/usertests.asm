...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     338:	ef450513          	addi	a0,a0,-268 # 6228 <malloc+0x20c>
     33c:	00006097          	auipc	ra,0x6
     340:	c28080e7          	jalr	-984(ra) # 5f64 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ee250513          	addi	a0,a0,-286 # 6240 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	ece98993          	addi	s3,s3,-306 # 6240 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e8250513          	addi	a0,a0,-382 # 6240 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	df258593          	addi	a1,a1,-526 # 61c8 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f0:	e7450513          	addi	a0,a0,-396 # 6260 <malloc+0x244>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b70080e7          	jalr	-1168(ra) # 5f64 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e4250513          	addi	a0,a0,-446 # 6248 <malloc+0x22c>
     40e:	00006097          	auipc	ra,0x6
     412:	b56080e7          	jalr	-1194(ra) # 5f64 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	e2850513          	addi	a0,a0,-472 # 6248 <malloc+0x22c>
     428:	00006097          	auipc	ra,0x6
     42c:	b3c080e7          	jalr	-1220(ra) # 5f64 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	dfc50513          	addi	a0,a0,-516 # 6240 <malloc+0x224>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d20a0a13          	addi	s4,s4,-736 # 6270 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c7c50513          	addi	a0,a0,-900 # 6278 <malloc+0x25c>
     604:	00006097          	auipc	ra,0x6
     608:	960080e7          	jalr	-1696(ra) # 5f64 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c7650513          	addi	a0,a0,-906 # 6290 <malloc+0x274>
     622:	00006097          	auipc	ra,0x6
     626:	942080e7          	jalr	-1726(ra) # 5f64 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c8850513          	addi	a0,a0,-888 # 62c0 <malloc+0x2a4>
     640:	00006097          	auipc	ra,0x6
     644:	924080e7          	jalr	-1756(ra) # 5f64 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c9e50513          	addi	a0,a0,-866 # 62f0 <malloc+0x2d4>
     65a:	00006097          	auipc	ra,0x6
     65e:	90a080e7          	jalr	-1782(ra) # 5f64 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c9050513          	addi	a0,a0,-880 # 6300 <malloc+0x2e4>
     678:	00006097          	auipc	ra,0x6
     67c:	8ec080e7          	jalr	-1812(ra) # 5f64 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c82a0a13          	addi	s4,s4,-894 # 6330 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b12a8a93          	addi	s5,s5,-1262 # 61c8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bdc50513          	addi	a0,a0,-1060 # 6338 <malloc+0x31c>
     764:	00006097          	auipc	ra,0x6
     768:	800080e7          	jalr	-2048(ra) # 5f64 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	bd650513          	addi	a0,a0,-1066 # 6350 <malloc+0x334>
     782:	00005097          	auipc	ra,0x5
     786:	7e2080e7          	jalr	2018(ra) # 5f64 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b5c50513          	addi	a0,a0,-1188 # 62f0 <malloc+0x2d4>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7c8080e7          	jalr	1992(ra) # 5f64 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	bd250513          	addi	a0,a0,-1070 # 6380 <malloc+0x364>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	7ae080e7          	jalr	1966(ra) # 5f64 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	bcc50513          	addi	a0,a0,-1076 # 6398 <malloc+0x37c>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	790080e7          	jalr	1936(ra) # 5f64 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	99e58593          	addi	a1,a1,-1634 # 61c0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	97250513          	addi	a0,a0,-1678 # 61b0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	94650513          	addi	a0,a0,-1722 # 61b0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	93250513          	addi	a0,a0,-1742 # 61b0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b6c58593          	addi	a1,a1,-1172 # 6428 <malloc+0x40c>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8b250513          	addi	a0,a0,-1870 # 61b0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a8650513          	addi	a0,a0,-1402 # 63c8 <malloc+0x3ac>
     94a:	00005097          	auipc	ra,0x5
     94e:	61a080e7          	jalr	1562(ra) # 5f64 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a8a50513          	addi	a0,a0,-1398 # 63e8 <malloc+0x3cc>
     966:	00005097          	auipc	ra,0x5
     96a:	5fe080e7          	jalr	1534(ra) # 5f64 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a8650513          	addi	a0,a0,-1402 # 63f8 <malloc+0x3dc>
     97a:	00005097          	auipc	ra,0x5
     97e:	5ea080e7          	jalr	1514(ra) # 5f64 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a8a50513          	addi	a0,a0,-1398 # 6418 <malloc+0x3fc>
     996:	00005097          	auipc	ra,0x5
     99a:	5ce080e7          	jalr	1486(ra) # 5f64 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a5650513          	addi	a0,a0,-1450 # 63f8 <malloc+0x3dc>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	5ba080e7          	jalr	1466(ra) # 5f64 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a7050513          	addi	a0,a0,-1424 # 6430 <malloc+0x414>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	59c080e7          	jalr	1436(ra) # 5f64 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a7250513          	addi	a0,a0,-1422 # 6450 <malloc+0x434>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	57e080e7          	jalr	1406(ra) # 5f64 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a5e50513          	addi	a0,a0,-1442 # 6470 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a6e98993          	addi	s3,s3,-1426 # 6498 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a9ea8a93          	addi	s5,s5,-1378 # 64d0 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9f850513          	addi	a0,a0,-1544 # 6470 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9bc50513          	addi	a0,a0,-1604 # 6470 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	99a50513          	addi	a0,a0,-1638 # 6478 <malloc+0x45c>
     ae6:	00005097          	auipc	ra,0x5
     aea:	47e080e7          	jalr	1150(ra) # 5f64 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	9ac50513          	addi	a0,a0,-1620 # 64a8 <malloc+0x48c>
     b04:	00005097          	auipc	ra,0x5
     b08:	460080e7          	jalr	1120(ra) # 5f64 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	9c650513          	addi	a0,a0,-1594 # 64e0 <malloc+0x4c4>
     b22:	00005097          	auipc	ra,0x5
     b26:	442080e7          	jalr	1090(ra) # 5f64 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9d250513          	addi	a0,a0,-1582 # 6508 <malloc+0x4ec>
     b3e:	00005097          	auipc	ra,0x5
     b42:	426080e7          	jalr	1062(ra) # 5f64 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9d650513          	addi	a0,a0,-1578 # 6528 <malloc+0x50c>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	40a080e7          	jalr	1034(ra) # 5f64 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9d250513          	addi	a0,a0,-1582 # 6540 <malloc+0x524>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3ee080e7          	jalr	1006(ra) # 5f64 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9c050513          	addi	a0,a0,-1600 # 6560 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	96e50513          	addi	a0,a0,-1682 # 6560 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	92e50513          	addi	a0,a0,-1746 # 6568 <malloc+0x54c>
     c42:	00005097          	auipc	ra,0x5
     c46:	322080e7          	jalr	802(ra) # 5f64 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	93050513          	addi	a0,a0,-1744 # 6588 <malloc+0x56c>
     c60:	00005097          	auipc	ra,0x5
     c64:	304080e7          	jalr	772(ra) # 5f64 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	93c50513          	addi	a0,a0,-1732 # 65b0 <malloc+0x594>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2e8080e7          	jalr	744(ra) # 5f64 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8c050513          	addi	a0,a0,-1856 # 6560 <malloc+0x544>
     ...
     cd0:	90450513          	addi	a0,a0,-1788 # 65d0 <malloc+0x5b4>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	290080e7          	jalr	656(ra) # 5f64 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	90e50513          	addi	a0,a0,-1778 # 65f8 <malloc+0x5dc>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	272080e7          	jalr	626(ra) # 5f64 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	90850513          	addi	a0,a0,-1784 # 6610 <malloc+0x5f4>
     d10:	00005097          	auipc	ra,0x5
     d14:	254080e7          	jalr	596(ra) # 5f64 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	91450513          	addi	a0,a0,-1772 # 6638 <malloc+0x61c>
     d2c:	00005097          	auipc	ra,0x5
     d30:	238080e7          	jalr	568(ra) # 5f64 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8fe50513          	addi	a0,a0,-1794 # 6650 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	91658593          	addi	a1,a1,-1770 # 6680 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ca50513          	addi	a0,a0,-1846 # 6650 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8b450513          	addi	a0,a0,-1868 # 6650 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	89e50513          	addi	a0,a0,-1890 # 6650 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	90258593          	addi	a1,a1,-1790 # 66c8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     e32:	82250513          	addi	a0,a0,-2014 # 6650 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	81250513          	addi	a0,a0,-2030 # 6660 <malloc+0x644>
     e56:	00005097          	auipc	ra,0x5
     e5a:	10e080e7          	jalr	270(ra) # 5f64 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	81e50513          	addi	a0,a0,-2018 # 6688 <malloc+0x66c>
     e72:	00005097          	auipc	ra,0x5
     e76:	0f2080e7          	jalr	242(ra) # 5f64 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	82250513          	addi	a0,a0,-2014 # 66a8 <malloc+0x68c>
     e8e:	00005097          	auipc	ra,0x5
     e92:	0d6080e7          	jalr	214(ra) # 5f64 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	82e50513          	addi	a0,a0,-2002 # 66d0 <malloc+0x6b4>
     eaa:	00005097          	auipc	ra,0x5
     eae:	0ba080e7          	jalr	186(ra) # 5f64 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	83250513          	addi	a0,a0,-1998 # 66f0 <malloc+0x6d4>
     ec6:	00005097          	auipc	ra,0x5
     eca:	09e080e7          	jalr	158(ra) # 5f64 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	83650513          	addi	a0,a0,-1994 # 6710 <malloc+0x6f4>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	082080e7          	jalr	130(ra) # 5f64 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	74258593          	addi	a1,a1,1858 # 6680 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7da58593          	addi	a1,a1,2010 # 6738 <malloc+0x71c>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ca50513          	addi	a0,a0,1994 # 6730 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f7e:	7b650513          	addi	a0,a0,1974 # 6730 <malloc+0x714>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7a450513          	addi	a0,a0,1956 # 6730 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	79650513          	addi	a0,a0,1942 # 6738 <malloc+0x71c>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	75e58593          	addi	a1,a1,1886 # 6738 <malloc+0x71c>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	74850513          	addi	a0,a0,1864 # 6738 <malloc+0x71c>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	73058593          	addi	a1,a1,1840 # 6730 <malloc+0x714>
    1008:	00005517          	auipc	a0,0x5
    100c:	73050513          	addi	a0,a0,1840 # 6738 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	71458593          	addi	a1,a1,1812 # 6730 <malloc+0x714>
    1024:	00006517          	auipc	a0,0x6
    1028:	81c50513          	addi	a0,a0,-2020 # 6840 <malloc+0x824>
    ...
    104a:	6fa50513          	addi	a0,a0,1786 # 6740 <malloc+0x724>
    104e:	00005097          	auipc	ra,0x5
    1052:	f16080e7          	jalr	-234(ra) # 5f64 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6f650513          	addi	a0,a0,1782 # 6758 <malloc+0x73c>
    106a:	00005097          	auipc	ra,0x5
    106e:	efa080e7          	jalr	-262(ra) # 5f64 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6f250513          	addi	a0,a0,1778 # 6770 <malloc+0x754>
    1086:	00005097          	auipc	ra,0x5
    108a:	ede080e7          	jalr	-290(ra) # 5f64 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6f650513          	addi	a0,a0,1782 # 6790 <malloc+0x774>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ec2080e7          	jalr	-318(ra) # 5f64 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	70a50513          	addi	a0,a0,1802 # 67c0 <malloc+0x7a4>
    10be:	00005097          	auipc	ra,0x5
    10c2:	ea6080e7          	jalr	-346(ra) # 5f64 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	70650513          	addi	a0,a0,1798 # 67d8 <malloc+0x7bc>
    10da:	00005097          	auipc	ra,0x5
    10de:	e8a080e7          	jalr	-374(ra) # 5f64 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	70250513          	addi	a0,a0,1794 # 67f0 <malloc+0x7d4>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e6e080e7          	jalr	-402(ra) # 5f64 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	70e50513          	addi	a0,a0,1806 # 6818 <malloc+0x7fc>
    1112:	00005097          	auipc	ra,0x5
    1116:	e52080e7          	jalr	-430(ra) # 5f64 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	72250513          	addi	a0,a0,1826 # 6848 <malloc+0x82c>
    112e:	00005097          	auipc	ra,0x5
    1132:	e36080e7          	jalr	-458(ra) # 5f64 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	71098993          	addi	s3,s3,1808 # 6868 <malloc+0x84c>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6e450513          	addi	a0,a0,1764 # 6878 <malloc+0x85c>
    119c:	00005097          	auipc	ra,0x5
    11a0:	dc8080e7          	jalr	-568(ra) # 5f64 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	69ea0a13          	addi	s4,s4,1694 # 6898 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	64c50513          	addi	a0,a0,1612 # 6898 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5e450513          	addi	a0,a0,1508 # 68a0 <malloc+0x884>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	ca0080e7          	jalr	-864(ra) # 5f64 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	5e450513          	addi	a0,a0,1508 # 68c0 <malloc+0x8a4>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c80080e7          	jalr	-896(ra) # 5f64 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	5e850513          	addi	a0,a0,1512 # 68e0 <malloc+0x8c4>
    1300:	00005097          	auipc	ra,0x5
    1304:	c64080e7          	jalr	-924(ra) # 5f64 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	df498993          	addi	s3,s3,-524 # 6158 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	74a78793          	addi	a5,a5,1866 # 7b38 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    144e:	13678793          	addi	a5,a5,310 # 8580 <malloc+0x2564>
    ...
    1472:	cea50513          	addi	a0,a0,-790 # 6158 <malloc+0x13c>
    ...
    148a:	50250513          	addi	a0,a0,1282 # 6988 <malloc+0x96c>
    148e:	00005097          	auipc	ra,0x5
    1492:	ad6080e7          	jalr	-1322(ra) # 5f64 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	45a50513          	addi	a0,a0,1114 # 6900 <malloc+0x8e4>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	ab6080e7          	jalr	-1354(ra) # 5f64 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	45a50513          	addi	a0,a0,1114 # 6920 <malloc+0x904>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a96080e7          	jalr	-1386(ra) # 5f64 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	45850513          	addi	a0,a0,1112 # 6940 <malloc+0x924>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a74080e7          	jalr	-1420(ra) # 5f64 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	46050513          	addi	a0,a0,1120 # 6968 <malloc+0x94c>
    1510:	00005097          	auipc	ra,0x5
    1514:	a54080e7          	jalr	-1452(ra) # 5f64 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	8c650513          	addi	a0,a0,-1850 # 6de8 <malloc+0xdcc>
    152a:	00005097          	auipc	ra,0x5
    152e:	a3a080e7          	jalr	-1478(ra) # 5f64 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	44450513          	addi	a0,a0,1092 # 69b0 <malloc+0x994>
    1574:	00005097          	auipc	ra,0x5
    1578:	9f0080e7          	jalr	-1552(ra) # 5f64 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	c1a50513          	addi	a0,a0,-998 # 61b0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15cc:	be8a0a13          	addi	s4,s4,-1048 # 61b0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	440a8a93          	addi	s5,s5,1088 # 6a10 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	39850513          	addi	a0,a0,920 # 69e0 <malloc+0x9c4>
    1650:	00005097          	auipc	ra,0x5
    1654:	914080e7          	jalr	-1772(ra) # 5f64 <printf>
    exit(1);
    1658:	4505                	li	a0,1
    ...
    1668:	39450513          	addi	a0,a0,916 # 69f8 <malloc+0x9dc>
    166c:	00005097          	auipc	ra,0x5
    1670:	8f8080e7          	jalr	-1800(ra) # 5f64 <printf>
        exit(1);
    1674:	4505                	li	a0,1
    ...
    1686:	39e50513          	addi	a0,a0,926 # 6a20 <malloc+0xa04>
    168a:	00005097          	auipc	ra,0x5
    168e:	8da080e7          	jalr	-1830(ra) # 5f64 <printf>
        exit(1);
    1692:	4505                	li	a0,1
    ...
    16ac:	b08a0a13          	addi	s4,s4,-1272 # 61b0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	390a8a93          	addi	s5,s5,912 # 6a40 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	ab650513          	addi	a0,a0,-1354 # 61b0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    171c:	2e050513          	addi	a0,a0,736 # 69f8 <malloc+0x9dc>
    1720:	00005097          	auipc	ra,0x5
    1724:	844080e7          	jalr	-1980(ra) # 5f64 <printf>
      exit(1);
    1728:	4505                	li	a0,1
    ...
    173a:	31250513          	addi	a0,a0,786 # 6a48 <malloc+0xa2c>
    173e:	00005097          	auipc	ra,0x5
    1742:	826080e7          	jalr	-2010(ra) # 5f64 <printf>
      exit(1);
    1746:	4505                	li	a0,1
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	9fc78793          	addi	a5,a5,-1540 # 6158 <malloc+0x13c>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	30078793          	addi	a5,a5,768 # 6a68 <malloc+0xa4c>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	2f850513          	addi	a0,a0,760 # 6a70 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    17ac:	2c850513          	addi	a0,a0,712 # 6a70 <malloc+0xa54>
    ...
    17c8:	2cc50513          	addi	a0,a0,716 # 6a90 <malloc+0xa74>
    17cc:	00004097          	auipc	ra,0x4
    17d0:	798080e7          	jalr	1944(ra) # 5f64 <printf>
      exit(1);
    17d4:	4505                	li	a0,1
    ...
    17e6:	1fe50513          	addi	a0,a0,510 # 69e0 <malloc+0x9c4>
    17ea:	00004097          	auipc	ra,0x4
    17ee:	77a080e7          	jalr	1914(ra) # 5f64 <printf>
     exit(1);
    17f2:	4505                	li	a0,1
    ...
    1802:	27a50513          	addi	a0,a0,634 # 6a78 <malloc+0xa5c>
    1806:	00004097          	auipc	ra,0x4
    180a:	75e080e7          	jalr	1886(ra) # 5f64 <printf>
      exit(1);
    180e:	4505                	li	a0,1
    ...
    1820:	93c50513          	addi	a0,a0,-1732 # 6158 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1854:	25050513          	addi	a0,a0,592 # 6aa0 <malloc+0xa84>
    1858:	00004097          	auipc	ra,0x4
    185c:	70c080e7          	jalr	1804(ra) # 5f64 <printf>
      exit(1);
    1860:	4505                	li	a0,1
    ...
    1870:	24c50513          	addi	a0,a0,588 # 6ab8 <malloc+0xa9c>
    1874:	00004097          	auipc	ra,0x4
    1878:	6f0080e7          	jalr	1776(ra) # 5f64 <printf>
    187c:	b7d1                	j	1840 <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    187e:	4581                	li	a1,0
    1880:	00005517          	auipc	a0,0x5
    1884:	1f050513          	addi	a0,a0,496 # 6a70 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	c7e50513          	addi	a0,a0,-898 # 6528 <malloc+0x50c>
    18b2:	00004097          	auipc	ra,0x4
    18b6:	6b2080e7          	jalr	1714(ra) # 5f64 <printf>
    exit(1);
    18ba:	4505                	li	a0,1
    ...
    18ca:	13250513          	addi	a0,a0,306 # 69f8 <malloc+0x9dc>
    18ce:	00004097          	auipc	ra,0x4
    18d2:	696080e7          	jalr	1686(ra) # 5f64 <printf>
    exit(1);
    18d6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18e4:	19050513          	addi	a0,a0,400 # 6a70 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	1c650513          	addi	a0,a0,454 # 6ad0 <malloc+0xab4>
    1912:	00004097          	auipc	ra,0x4
    1916:	652080e7          	jalr	1618(ra) # 5f64 <printf>
    exit(1);
    191a:	4505                	li	a0,1
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d6:	11650513          	addi	a0,a0,278 # 6ae8 <malloc+0xacc>
    19da:	00004097          	auipc	ra,0x4
    19de:	58a080e7          	jalr	1418(ra) # 5f64 <printf>
    exit(1);
    19e2:	4505                	li	a0,1
    ...
    1a18:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0a050513          	addi	a0,a0,160 # 6b00 <malloc+0xae4>
    1a68:	00004097          	auipc	ra,0x4
    1a6c:	4fc080e7          	jalr	1276(ra) # 5f64 <printf>
        exit(1);
    1a70:	4505                	li	a0,1
    ...
    1a80:	09c50513          	addi	a0,a0,156 # 6b18 <malloc+0xafc>
    1a84:	00004097          	auipc	ra,0x4
    1a88:	4e0080e7          	jalr	1248(ra) # 5f64 <printf>
          return;
    ...
    1ab2:	08250513          	addi	a0,a0,130 # 6b30 <malloc+0xb14>
    1ab6:	00004097          	auipc	ra,0x4
    1aba:	4ae080e7          	jalr	1198(ra) # 5f64 <printf>
      exit(1);
    1abe:	4505                	li	a0,1
    ...
    1afe:	05650513          	addi	a0,a0,86 # 6b50 <malloc+0xb34>
    1b02:	00004097          	auipc	ra,0x4
    1b06:	462080e7          	jalr	1122(ra) # 5f64 <printf>
    exit(1);
    1b0a:	4505                	li	a0,1
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	e7450513          	addi	a0,a0,-396 # 69e0 <malloc+0x9c4>
    1b74:	00004097          	auipc	ra,0x4
    1b78:	3f0080e7          	jalr	1008(ra) # 5f64 <printf>
      exit(1);
    1b7c:	4505                	li	a0,1
    ...
    1b8c:	fe050513          	addi	a0,a0,-32 # 6b68 <malloc+0xb4c>
    1b90:	00004097          	auipc	ra,0x4
    1b94:	3d4080e7          	jalr	980(ra) # 5f64 <printf>
        exit(1);
    1b98:	4505                	li	a0,1
    ...
    1ba8:	fdc50513          	addi	a0,a0,-36 # 6b80 <malloc+0xb64>
    1bac:	00004097          	auipc	ra,0x4
    1bb0:	3b8080e7          	jalr	952(ra) # 5f64 <printf>
        exit(1);
    1bb4:	4505                	li	a0,1
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	dc450513          	addi	a0,a0,-572 # 69e0 <malloc+0x9c4>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	340080e7          	jalr	832(ra) # 5f64 <printf>
      exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c44:	da050513          	addi	a0,a0,-608 # 69e0 <malloc+0x9c4>
    1c48:	00004097          	auipc	ra,0x4
    1c4c:	31c080e7          	jalr	796(ra) # 5f64 <printf>
        exit(1);
    1c50:	4505                	li	a0,1
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	ee650513          	addi	a0,a0,-282 # 6ba0 <malloc+0xb84>
    1cc2:	00004097          	auipc	ra,0x4
    1cc6:	2a2080e7          	jalr	674(ra) # 5f64 <printf>
      exit(1);
    1cca:	4505                	li	a0,1
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	e9e50513          	addi	a0,a0,-354 # 6bb0 <malloc+0xb94>
    1d1a:	00004097          	auipc	ra,0x4
    1d1e:	24a080e7          	jalr	586(ra) # 5f64 <printf>
      exit(1);
    1d22:	4505                	li	a0,1
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	08850513          	addi	a0,a0,136 # 6de8 <malloc+0xdcc>
    1d68:	00004097          	auipc	ra,0x4
    1d6c:	1fc080e7          	jalr	508(ra) # 5f64 <printf>
      exit(1);
    1d70:	4505                	li	a0,1
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	fea50513          	addi	a0,a0,-22 # 6de8 <malloc+0xdcc>
    1e06:	00004097          	auipc	ra,0x4
    1e0a:	15e080e7          	jalr	350(ra) # 5f64 <printf>
      exit(1);
    1e0e:	4505                	li	a0,1
    ...
    1e2e:	c4e50513          	addi	a0,a0,-946 # 6a78 <malloc+0xa5c>
    1e32:	00004097          	auipc	ra,0x4
    1e36:	132080e7          	jalr	306(ra) # 5f64 <printf>
          exit(1);
    1e3a:	4505                	li	a0,1
    ...
    1ea0:	d3450513          	addi	a0,a0,-716 # 6bd0 <malloc+0xbb4>
    1ea4:	00004097          	auipc	ra,0x4
    1ea8:	0c0080e7          	jalr	192(ra) # 5f64 <printf>
            exit(1);
    1eac:	4505                	li	a0,1
    ...
    1ed4:	d1850513          	addi	a0,a0,-744 # 6be8 <malloc+0xbcc>
    1ed8:	00004097          	auipc	ra,0x4
    1edc:	08c080e7          	jalr	140(ra) # 5f64 <printf>
        exit(1);
    1ee0:	4505                	li	a0,1
    ...
    1f36:	cde50513          	addi	a0,a0,-802 # 6c10 <malloc+0xbf4>
    1f3a:	00004097          	auipc	ra,0x4
    1f3e:	02a080e7          	jalr	42(ra) # 5f64 <printf>
        exit(1);
    1f42:	4505                	li	a0,1
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	1f250513          	addi	a0,a0,498 # 61c8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2016:	1b6b0b13          	addi	s6,s6,438 # 61c8 <malloc+0x1ac>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c1ec0c13          	addi	s8,s8,-994 # 6c38 <malloc+0xc1c>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9ba50513          	addi	a0,a0,-1606 # 69e0 <malloc+0x9c4>
    202e:	00004097          	auipc	ra,0x4
    2032:	f36080e7          	jalr	-202(ra) # 5f64 <printf>
    exit(1);
    2036:	4505                	li	a0,1
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	b9e50513          	addi	a0,a0,-1122 # 6c88 <malloc+0xc6c>
    20f2:	00004097          	auipc	ra,0x4
    20f6:	e72080e7          	jalr	-398(ra) # 5f64 <printf>
    exit(1);
    20fa:	4505                	li	a0,1
    ...
    2112:	b3250513          	addi	a0,a0,-1230 # 6c40 <malloc+0xc24>
    2116:	00004097          	auipc	ra,0x4
    211a:	e4e080e7          	jalr	-434(ra) # 5f64 <printf>
    exit(1);
    211e:	4505                	li	a0,1
    ...
    212e:	b2e50513          	addi	a0,a0,-1234 # 6c58 <malloc+0xc3c>
    2132:	00004097          	auipc	ra,0x4
    2136:	e32080e7          	jalr	-462(ra) # 5f64 <printf>
      exit(1);
    213a:	4505                	li	a0,1
    ...
    214a:	b2a50513          	addi	a0,a0,-1238 # 6c70 <malloc+0xc54>
    214e:	00004097          	auipc	ra,0x4
    2152:	e16080e7          	jalr	-490(ra) # 5f64 <printf>
    exit(1);
    2156:	4505                	li	a0,1
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	7e450513          	addi	a0,a0,2020 # 69e0 <malloc+0x9c4>
    2204:	00004097          	auipc	ra,0x4
    2208:	d60080e7          	jalr	-672(ra) # 5f64 <printf>
      exit(1);
    220c:	4505                	li	a0,1
    ...
    2222:	a9250513          	addi	a0,a0,-1390 # 6cb0 <malloc+0xc94>
    2226:	00004097          	auipc	ra,0x4
    222a:	d3e080e7          	jalr	-706(ra) # 5f64 <printf>
      exit(1);
    222e:	4505                	li	a0,1
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	74050513          	addi	a0,a0,1856 # 69e0 <malloc+0x9c4>
    22a8:	00004097          	auipc	ra,0x4
    22ac:	cbc080e7          	jalr	-836(ra) # 5f64 <printf>
      exit(1);
    22b0:	4505                	li	a0,1
    ...
    22d0:	a0450513          	addi	a0,a0,-1532 # 6cd0 <malloc+0xcb4>
    22d4:	00004097          	auipc	ra,0x4
    22d8:	c90080e7          	jalr	-880(ra) # 5f64 <printf>
      exit(1);
    22dc:	4505                	li	a0,1
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	9ec50513          	addi	a0,a0,-1556 # 6ce8 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	9ba50513          	addi	a0,a0,-1606 # 6ce8 <malloc+0xccc>
  ...
  close(fd);
    ...
    2368:	99470713          	addi	a4,a4,-1644 # 6cf8 <malloc+0xcdc>
    ...
    23bc:	a2050513          	addi	a0,a0,-1504 # 6dd8 <malloc+0xdbc>
    ...
    23e0:	a1c50513          	addi	a0,a0,-1508 # 6df8 <malloc+0xddc>
    23e4:	00004097          	auipc	ra,0x4
    23e8:	b80080e7          	jalr	-1152(ra) # 5f64 <printf>
    exit(1);
    23ec:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	9de50513          	addi	a0,a0,-1570 # 6e18 <malloc+0xdfc>
    2442:	00004097          	auipc	ra,0x4
    2446:	b22080e7          	jalr	-1246(ra) # 5f64 <printf>
    exit(1);
    244a:	4505                	li	a0,1
    ...
    245a:	58a50513          	addi	a0,a0,1418 # 69e0 <malloc+0x9c4>
    245e:	00004097          	auipc	ra,0x4
    2462:	b06080e7          	jalr	-1274(ra) # 5f64 <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	51c50513          	addi	a0,a0,1308 # 69e0 <malloc+0x9c4>
    24cc:	00004097          	auipc	ra,0x4
    24d0:	a98080e7          	jalr	-1384(ra) # 5f64 <printf>
    exit(1);
    24d4:	4505                	li	a0,1
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	8a050513          	addi	a0,a0,-1888 # 6de8 <malloc+0xdcc>
    2550:	00004097          	auipc	ra,0x4
    2554:	a14080e7          	jalr	-1516(ra) # 5f64 <printf>
      exit(1);
    2558:	4505                	li	a0,1
    ...
    2602:	84250513          	addi	a0,a0,-1982 # 6e40 <malloc+0xe24>
    2606:	00004097          	auipc	ra,0x4
    260a:	95e080e7          	jalr	-1698(ra) # 5f64 <printf>
            exit(1);
    260e:	4505                	li	a0,1
    ...
    2622:	c0a50513          	addi	a0,a0,-1014 # 6228 <malloc+0x20c>
    2626:	00004097          	auipc	ra,0x4
    262a:	93e080e7          	jalr	-1730(ra) # 5f64 <printf>
            exit(1);
    262e:	4505                	li	a0,1
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	48278793          	addi	a5,a5,1154 # 7b38 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26fc:	76050513          	addi	a0,a0,1888 # 6e58 <malloc+0xe3c>
    2700:	00004097          	auipc	ra,0x4
    2704:	864080e7          	jalr	-1948(ra) # 5f64 <printf>
    exit(1);
    2708:	4505                	li	a0,1
    ...
    271a:	1ea50513          	addi	a0,a0,490 # 6900 <malloc+0x8e4>
    271e:	00004097          	auipc	ra,0x4
    2722:	846080e7          	jalr	-1978(ra) # 5f64 <printf>
    exit(1);
    2726:	4505                	li	a0,1
    ...
    2738:	1ec50513          	addi	a0,a0,492 # 6920 <malloc+0x904>
    273c:	00004097          	auipc	ra,0x4
    2740:	828080e7          	jalr	-2008(ra) # 5f64 <printf>
    exit(1);
    2744:	4505                	li	a0,1
    ...
    2758:	1ec50513          	addi	a0,a0,492 # 6940 <malloc+0x924>
    275c:	00004097          	auipc	ra,0x4
    2760:	808080e7          	jalr	-2040(ra) # 5f64 <printf>
    exit(1);
    2764:	4505                	li	a0,1
    ...
    2776:	1f650513          	addi	a0,a0,502 # 6968 <malloc+0x94c>
    277a:	00003097          	auipc	ra,0x3
    277e:	7ea080e7          	jalr	2026(ra) # 5f64 <printf>
    exit(1);
    2782:	4505                	li	a0,1
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	6da50513          	addi	a0,a0,1754 # 6e98 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27f2:	6ca50513          	addi	a0,a0,1738 # 6eb8 <malloc+0xe9c>
    27f6:	00003097          	auipc	ra,0x3
    27fa:	76e080e7          	jalr	1902(ra) # 5f64 <printf>
    exit(1);
    27fe:	4505                	li	a0,1
    ...
    2810:	65450513          	addi	a0,a0,1620 # 6e60 <malloc+0xe44>
    ...
    282c:	65050513          	addi	a0,a0,1616 # 6e78 <malloc+0xe5c>
    2830:	00003097          	auipc	ra,0x3
    2834:	734080e7          	jalr	1844(ra) # 5f64 <printf>
    exit(1);
    2838:	4505                	li	a0,1
    ...
    2846:	65e50513          	addi	a0,a0,1630 # 6ea0 <malloc+0xe84>
    284a:	00003097          	auipc	ra,0x3
    284e:	71a080e7          	jalr	1818(ra) # 5f64 <printf>
    exit(1);
    2852:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    286a:	63250513          	addi	a0,a0,1586 # 6e98 <malloc+0xe7c>
    286e:	00003097          	auipc	ra,0x3
    2872:	3de080e7          	jalr	990(ra) # 5c4c <unlink>
  fd = open("README", O_RDONLY);
    2876:	4581                	li	a1,0
    2878:	00004517          	auipc	a0,0x4
    287c:	ab850513          	addi	a0,a0,-1352 # 6330 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    28a6:	64650513          	addi	a0,a0,1606 # 6ee8 <malloc+0xecc>
    28aa:	00003097          	auipc	ra,0x3
    28ae:	6ba080e7          	jalr	1722(ra) # 5f64 <printf>
    exit(1);
    28b2:	4505                	li	a0,1
    ...
    28c0:	5e450513          	addi	a0,a0,1508 # 6ea0 <malloc+0xe84>
    28c4:	00003097          	auipc	ra,0x3
    28c8:	6a0080e7          	jalr	1696(ra) # 5f64 <printf>
    exit(1);
    28cc:	4505                	li	a0,1
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	5ce50513          	addi	a0,a0,1486 # 6f10 <malloc+0xef4>
    294a:	00003097          	auipc	ra,0x3
    294e:	61a080e7          	jalr	1562(ra) # 5f64 <printf>
    exit(1);
    2952:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	58a50513          	addi	a0,a0,1418 # 6f30 <malloc+0xf14>
    29ae:	00003097          	auipc	ra,0x3
    29b2:	5b6080e7          	jalr	1462(ra) # 5f64 <printf>
    exit(1);
    29b6:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2a0e:	58650513          	addi	a0,a0,1414 # 6f90 <malloc+0xf74>
    2a12:	00003097          	auipc	ra,0x3
    2a16:	552080e7          	jalr	1362(ra) # 5f64 <printf>
    exit(1);
    2a1a:	4505                	li	a0,1
    ...
    2a30:	52450513          	addi	a0,a0,1316 # 6f50 <malloc+0xf34>
    2a34:	00003097          	auipc	ra,0x3
    2a38:	530080e7          	jalr	1328(ra) # 5f64 <printf>
      exit(1);
    2a3c:	4505                	li	a0,1
    ...
    2a4c:	52850513          	addi	a0,a0,1320 # 6f70 <malloc+0xf54>
    2a50:	00003097          	auipc	ra,0x3
    2a54:	514080e7          	jalr	1300(ra) # 5f64 <printf>
    exit(1);
    2a58:	4505                	li	a0,1
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	41e50513          	addi	a0,a0,1054 # 6fb0 <malloc+0xf94>
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	3ca080e7          	jalr	970(ra) # 5f64 <printf>
    exit(1);
    2ba2:	4505                	li	a0,1
    ...
    2bb2:	44a50513          	addi	a0,a0,1098 # 6ff8 <malloc+0xfdc>
    2bb6:	00003097          	auipc	ra,0x3
    2bba:	3ae080e7          	jalr	942(ra) # 5f64 <printf>
    exit(1);
    2bbe:	4505                	li	a0,1
    ...
    2bd2:	44a50513          	addi	a0,a0,1098 # 7018 <malloc+0xffc>
    2bd6:	00003097          	auipc	ra,0x3
    2bda:	38e080e7          	jalr	910(ra) # 5f64 <printf>
    exit(1);
    2bde:	4505                	li	a0,1
    ...
    2bf2:	46a50513          	addi	a0,a0,1130 # 7058 <malloc+0x103c>
    2bf6:	00003097          	auipc	ra,0x3
    2bfa:	36e080e7          	jalr	878(ra) # 5f64 <printf>
    exit(1);
    2bfe:	4505                	li	a0,1
    ...
    2c0e:	47e50513          	addi	a0,a0,1150 # 7088 <malloc+0x106c>
    2c12:	00003097          	auipc	ra,0x3
    2c16:	352080e7          	jalr	850(ra) # 5f64 <printf>
    exit(1);
    2c1a:	4505                	li	a0,1
    ...
    2c2e:	49650513          	addi	a0,a0,1174 # 70c0 <malloc+0x10a4>
    2c32:	00003097          	auipc	ra,0x3
    2c36:	332080e7          	jalr	818(ra) # 5f64 <printf>
    exit(1);
    2c3a:	4505                	li	a0,1
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	48450513          	addi	a0,a0,1156 # 70e8 <malloc+0x10cc>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	47250513          	addi	a0,a0,1138 # 70e8 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	42650513          	addi	a0,a0,1062 # 70f0 <malloc+0x10d4>
    2cd2:	00003097          	auipc	ra,0x3
    2cd6:	292080e7          	jalr	658(ra) # 5f64 <printf>
    exit(1);
    2cda:	4505                	li	a0,1
    ...
    2cea:	42250513          	addi	a0,a0,1058 # 7108 <malloc+0x10ec>
    2cee:	00003097          	auipc	ra,0x3
    2cf2:	276080e7          	jalr	630(ra) # 5f64 <printf>
    exit(1);
    2cf6:	4505                	li	a0,1
    ...
    2d06:	de650513          	addi	a0,a0,-538 # 6ae8 <malloc+0xacc>
    2d0a:	00003097          	auipc	ra,0x3
    2d0e:	25a080e7          	jalr	602(ra) # 5f64 <printf>
    exit(1);
    2d12:	4505                	li	a0,1
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	3f450513          	addi	a0,a0,1012 # 7120 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d78:	c8450513          	addi	a0,a0,-892 # 69f8 <malloc+0x9dc>
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	02650513          	addi	a0,a0,38 # 6de8 <malloc+0xdcc>
    2dca:	00003097          	auipc	ra,0x3
    2dce:	19a080e7          	jalr	410(ra) # 5f64 <printf>
    exit(1);
    2dd2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e1c:	fd050513          	addi	a0,a0,-48 # 6de8 <malloc+0xdcc>
    2e20:	00003097          	auipc	ra,0x3
    2e24:	144080e7          	jalr	324(ra) # 5f64 <printf>
    exit(1);
    2e28:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e7c:	f7050513          	addi	a0,a0,-144 # 6de8 <malloc+0xdcc>
    2e80:	00003097          	auipc	ra,0x3
    2e84:	0e4080e7          	jalr	228(ra) # 5f64 <printf>
    exit(1);
    2e88:	4505                	li	a0,1
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	dfc50513          	addi	a0,a0,-516 # 6de8 <malloc+0xdcc>
    2ff4:	00003097          	auipc	ra,0x3
    2ff8:	f70080e7          	jalr	-144(ra) # 5f64 <printf>
      exit(1);
    2ffc:	4505                	li	a0,1
    ...
    3044:	11850513          	addi	a0,a0,280 # 6158 <malloc+0x13c>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	17c78793          	addi	a5,a5,380 # 61c8 <malloc+0x1ac>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	27a50513          	addi	a0,a0,634 # 72f8 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	0c050513          	addi	a0,a0,192 # 7150 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	10250513          	addi	a0,a0,258 # 71a8 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	15c50513          	addi	a0,a0,348 # 7220 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	1b050513          	addi	a0,a0,432 # 7290 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	1f650513          	addi	a0,a0,502 # 72e8 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3174:	fb850513          	addi	a0,a0,-72 # 7128 <malloc+0x110c>
    3178:	00003097          	auipc	ra,0x3
    317c:	dec080e7          	jalr	-532(ra) # 5f64 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	fe450513          	addi	a0,a0,-28 # 7170 <malloc+0x1154>
    3194:	00003097          	auipc	ra,0x3
    3198:	dd0080e7          	jalr	-560(ra) # 5f64 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	03050513          	addi	a0,a0,48 # 71d8 <malloc+0x11bc>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	db4080e7          	jalr	-588(ra) # 5f64 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
    ...
    31c8:	08c50513          	addi	a0,a0,140 # 7250 <malloc+0x1234>
    31cc:	00003097          	auipc	ra,0x3
    31d0:	d98080e7          	jalr	-616(ra) # 5f64 <printf>
    exit(1);
    31d4:	4505                	li	a0,1
    ...
    31e4:	0d050513          	addi	a0,a0,208 # 72b0 <malloc+0x1294>
    31e8:	00003097          	auipc	ra,0x3
    31ec:	d7c080e7          	jalr	-644(ra) # 5f64 <printf>
    exit(1);
    31f0:	4505                	li	a0,1
    ...
    3200:	10c50513          	addi	a0,a0,268 # 7308 <malloc+0x12ec>
    3204:	00003097          	auipc	ra,0x3
    3208:	d60080e7          	jalr	-672(ra) # 5f64 <printf>
    exit(1);
    320c:	4505                	li	a0,1
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	0f850513          	addi	a0,a0,248 # 7340 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	0de50513          	addi	a0,a0,222 # 7350 <malloc+0x1334>
    327a:	00003097          	auipc	ra,0x3
    327e:	cea080e7          	jalr	-790(ra) # 5f64 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	03e50513          	addi	a0,a0,62 # 7340 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    331a:	02a50513          	addi	a0,a0,42 # 7340 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	f2c50513          	addi	a0,a0,-212 # 7370 <malloc+0x1354>
    344c:	00003097          	auipc	ra,0x3
    3450:	b18080e7          	jalr	-1256(ra) # 5f64 <printf>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	f3e50513          	addi	a0,a0,-194 # 73a0 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	f2a50513          	addi	a0,a0,-214 # 73a0 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	f5650513          	addi	a0,a0,-170 # 73e0 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	f7250513          	addi	a0,a0,-142 # 7410 <malloc+0x13f4>
    ...
    34c2:	eea50513          	addi	a0,a0,-278 # 73a8 <malloc+0x138c>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a9e080e7          	jalr	-1378(ra) # 5f64 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
    ...
    34de:	ee650513          	addi	a0,a0,-282 # 73c0 <malloc+0x13a4>
    34e2:	00003097          	auipc	ra,0x3
    34e6:	a82080e7          	jalr	-1406(ra) # 5f64 <printf>
    exit(1);
    34ea:	4505                	li	a0,1
    ...
    34fa:	efa50513          	addi	a0,a0,-262 # 73f0 <malloc+0x13d4>
    34fe:	00003097          	auipc	ra,0x3
    3502:	a66080e7          	jalr	-1434(ra) # 5f64 <printf>
    exit(1);
    3506:	4505                	li	a0,1
    ...
    3516:	f0650513          	addi	a0,a0,-250 # 7418 <malloc+0x13fc>
    351a:	00003097          	auipc	ra,0x3
    351e:	a4a080e7          	jalr	-1462(ra) # 5f64 <printf>
    exit(1);
    3522:	4505                	li	a0,1
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	e5a50513          	addi	a0,a0,-422 # 73a0 <malloc+0x1384>
    ...
    355e:	e4650513          	addi	a0,a0,-442 # 73a0 <malloc+0x1384>
    ...
    3572:	e7250513          	addi	a0,a0,-398 # 73e0 <malloc+0x13c4>
    ...
    3592:	45250513          	addi	a0,a0,1106 # 69e0 <malloc+0x9c4>
    3596:	00003097          	auipc	ra,0x3
    359a:	9ce080e7          	jalr	-1586(ra) # 5f64 <printf>
    exit(1);
    359e:	4505                	li	a0,1
    ...
    35ae:	dfe50513          	addi	a0,a0,-514 # 73a8 <malloc+0x138c>
    35b2:	00003097          	auipc	ra,0x3
    35b6:	9b2080e7          	jalr	-1614(ra) # 5f64 <printf>
      exit(1);
    35ba:	4505                	li	a0,1
    ...
    35ca:	e6a50513          	addi	a0,a0,-406 # 7430 <malloc+0x1414>
    35ce:	00003097          	auipc	ra,0x3
    35d2:	996080e7          	jalr	-1642(ra) # 5f64 <printf>
      exit(1);
    35d6:	4505                	li	a0,1
    ...
    35e6:	e0e50513          	addi	a0,a0,-498 # 73f0 <malloc+0x13d4>
    35ea:	00003097          	auipc	ra,0x3
    35ee:	97a080e7          	jalr	-1670(ra) # 5f64 <printf>
      exit(1);
    35f2:	4505                	li	a0,1
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	e2850513          	addi	a0,a0,-472 # 7448 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	e1450513          	addi	a0,a0,-492 # 7448 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    364c:	e2050513          	addi	a0,a0,-480 # 7468 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	dec50513          	addi	a0,a0,-532 # 7448 <malloc+0x142c>
    ...
    3680:	d2c50513          	addi	a0,a0,-724 # 73a8 <malloc+0x138c>
    3684:	00003097          	auipc	ra,0x3
    3688:	8e0080e7          	jalr	-1824(ra) # 5f64 <printf>
    exit(1);
    368c:	4505                	li	a0,1
    ...
    369c:	db850513          	addi	a0,a0,-584 # 7450 <malloc+0x1434>
    36a0:	00003097          	auipc	ra,0x3
    36a4:	8c4080e7          	jalr	-1852(ra) # 5f64 <printf>
    exit(1);
    36a8:	4505                	li	a0,1
    ...
    36b8:	dbc50513          	addi	a0,a0,-580 # 7470 <malloc+0x1454>
    36bc:	00003097          	auipc	ra,0x3
    36c0:	8a8080e7          	jalr	-1880(ra) # 5f64 <printf>
    exit(1);
    36c4:	4505                	li	a0,1
    ...
    36d4:	db850513          	addi	a0,a0,-584 # 7488 <malloc+0x146c>
    36d8:	00003097          	auipc	ra,0x3
    36dc:	88c080e7          	jalr	-1908(ra) # 5f64 <printf>
    exit(1);
    36e0:	4505                	li	a0,1
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	ed850513          	addi	a0,a0,-296 # 75d0 <malloc+0x15b4>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	d9850513          	addi	a0,a0,-616 # 74a0 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	da050513          	addi	a0,a0,-608 # 74c0 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    373c:	e9858593          	addi	a1,a1,-360 # 75d0 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	d4e50513          	addi	a0,a0,-690 # 74a0 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	db250513          	addi	a0,a0,-590 # 7518 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	dc250513          	addi	a0,a0,-574 # 7540 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    379a:	dda58593          	addi	a1,a1,-550 # 7570 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	dc650513          	addi	a0,a0,-570 # 7578 <malloc+0x155c>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	dce58593          	addi	a1,a1,-562 # 75c8 <malloc+0x15ac>
    3802:	00004517          	auipc	a0,0x4
    3806:	d3e50513          	addi	a0,a0,-706 # 7540 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	d2a50513          	addi	a0,a0,-726 # 7540 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	d1450513          	addi	a0,a0,-748 # 7540 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	c6050513          	addi	a0,a0,-928 # 74a0 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e0c50513          	addi	a0,a0,-500 # 7660 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	e2850513          	addi	a0,a0,-472 # 7690 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	e4450513          	addi	a0,a0,-444 # 76c0 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	d3650513          	addi	a0,a0,-714 # 75c8 <malloc+0x15ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	c7450513          	addi	a0,a0,-908 # 7540 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	e6c50513          	addi	a0,a0,-404 # 7750 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	e8450513          	addi	a0,a0,-380 # 7780 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	b8c50513          	addi	a0,a0,-1140 # 74a0 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	b7650513          	addi	a0,a0,-1162 # 74a0 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	b6050513          	addi	a0,a0,-1184 # 74a0 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	ebc58593          	addi	a1,a1,-324 # 7810 <malloc+0x17f4>
    395c:	00004517          	auipc	a0,0x4
    3960:	df450513          	addi	a0,a0,-524 # 7750 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	ea058593          	addi	a1,a1,-352 # 7810 <malloc+0x17f4>
    3978:	00004517          	auipc	a0,0x4
    397c:	e0850513          	addi	a0,a0,-504 # 7780 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	c3c58593          	addi	a1,a1,-964 # 75c8 <malloc+0x15ac>
    3994:	00004517          	auipc	a0,0x4
    3998:	b2c50513          	addi	a0,a0,-1236 # 74c0 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	da850513          	addi	a0,a0,-600 # 7750 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	dc450513          	addi	a0,a0,-572 # 7780 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	bf850513          	addi	a0,a0,-1032 # 75c8 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	d9c50513          	addi	a0,a0,-612 # 7780 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	d5850513          	addi	a0,a0,-680 # 7750 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	ab450513          	addi	a0,a0,-1356 # 74c0 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	f4050513          	addi	a0,a0,-192 # 7960 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	b9450513          	addi	a0,a0,-1132 # 75c8 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	a7850513          	addi	a0,a0,-1416 # 74c0 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	a4450513          	addi	a0,a0,-1468 # 74a0 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	f6050513          	addi	a0,a0,-160 # 79d0 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	a1c50513          	addi	a0,a0,-1508 # 74a0 <malloc+0x1484>
    ...
    3aaa:	a0250513          	addi	a0,a0,-1534 # 74a8 <malloc+0x148c>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	4b6080e7          	jalr	1206(ra) # 5f64 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a0650513          	addi	a0,a0,-1530 # 74c8 <malloc+0x14ac>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	49a080e7          	jalr	1178(ra) # 5f64 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a0a50513          	addi	a0,a0,-1526 # 74e8 <malloc+0x14cc>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	47e080e7          	jalr	1150(ra) # 5f64 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a2650513          	addi	a0,a0,-1498 # 7520 <malloc+0x1504>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	462080e7          	jalr	1122(ra) # 5f64 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a3a50513          	addi	a0,a0,-1478 # 7550 <malloc+0x1534>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	446080e7          	jalr	1094(ra) # 5f64 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a5650513          	addi	a0,a0,-1450 # 7588 <malloc+0x156c>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	42a080e7          	jalr	1066(ra) # 5f64 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a5a50513          	addi	a0,a0,-1446 # 75a8 <malloc+0x158c>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	40e080e7          	jalr	1038(ra) # 5f64 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a6e50513          	addi	a0,a0,-1426 # 75d8 <malloc+0x15bc>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3f2080e7          	jalr	1010(ra) # 5f64 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	a7a50513          	addi	a0,a0,-1414 # 7600 <malloc+0x15e4>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	3d6080e7          	jalr	982(ra) # 5f64 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	a7e50513          	addi	a0,a0,-1410 # 7620 <malloc+0x1604>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	3ba080e7          	jalr	954(ra) # 5f64 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	a8a50513          	addi	a0,a0,-1398 # 7648 <malloc+0x162c>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	39e080e7          	jalr	926(ra) # 5f64 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	a9650513          	addi	a0,a0,-1386 # 7670 <malloc+0x1654>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	382080e7          	jalr	898(ra) # 5f64 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aaa50513          	addi	a0,a0,-1366 # 76a0 <malloc+0x1684>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	366080e7          	jalr	870(ra) # 5f64 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	ab650513          	addi	a0,a0,-1354 # 76c8 <malloc+0x16ac>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	34a080e7          	jalr	842(ra) # 5f64 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ab250513          	addi	a0,a0,-1358 # 76e0 <malloc+0x16c4>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	32e080e7          	jalr	814(ra) # 5f64 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	ab650513          	addi	a0,a0,-1354 # 7700 <malloc+0x16e4>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	312080e7          	jalr	786(ra) # 5f64 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	aba50513          	addi	a0,a0,-1350 # 7720 <malloc+0x1704>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2f6080e7          	jalr	758(ra) # 5f64 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	ade50513          	addi	a0,a0,-1314 # 7760 <malloc+0x1744>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	2da080e7          	jalr	730(ra) # 5f64 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	af250513          	addi	a0,a0,-1294 # 7790 <malloc+0x1774>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	2be080e7          	jalr	702(ra) # 5f64 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	af650513          	addi	a0,a0,-1290 # 77b0 <malloc+0x1794>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	2a2080e7          	jalr	674(ra) # 5f64 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	afa50513          	addi	a0,a0,-1286 # 77d0 <malloc+0x17b4>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	286080e7          	jalr	646(ra) # 5f64 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	afe50513          	addi	a0,a0,-1282 # 77f0 <malloc+0x17d4>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	26a080e7          	jalr	618(ra) # 5f64 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b1250513          	addi	a0,a0,-1262 # 7820 <malloc+0x1804>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	24e080e7          	jalr	590(ra) # 5f64 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b1e50513          	addi	a0,a0,-1250 # 7848 <malloc+0x182c>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	232080e7          	jalr	562(ra) # 5f64 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b2a50513          	addi	a0,a0,-1238 # 7870 <malloc+0x1854>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	216080e7          	jalr	534(ra) # 5f64 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b3650513          	addi	a0,a0,-1226 # 7898 <malloc+0x187c>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1fa080e7          	jalr	506(ra) # 5f64 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b3a50513          	addi	a0,a0,-1222 # 78b8 <malloc+0x189c>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1de080e7          	jalr	478(ra) # 5f64 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b3e50513          	addi	a0,a0,-1218 # 78d8 <malloc+0x18bc>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1c2080e7          	jalr	450(ra) # 5f64 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b4a50513          	addi	a0,a0,-1206 # 7900 <malloc+0x18e4>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	1a6080e7          	jalr	422(ra) # 5f64 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	b4e50513          	addi	a0,a0,-1202 # 7920 <malloc+0x1904>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	18a080e7          	jalr	394(ra) # 5f64 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b5250513          	addi	a0,a0,-1198 # 7940 <malloc+0x1924>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	16e080e7          	jalr	366(ra) # 5f64 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b5e50513          	addi	a0,a0,-1186 # 7968 <malloc+0x194c>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	152080e7          	jalr	338(ra) # 5f64 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	7da50513          	addi	a0,a0,2010 # 7600 <malloc+0x15e4>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	136080e7          	jalr	310(ra) # 5f64 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b4650513          	addi	a0,a0,-1210 # 7988 <malloc+0x196c>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	11a080e7          	jalr	282(ra) # 5f64 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
    ...
    3e62:	b4a50513          	addi	a0,a0,-1206 # 79a8 <malloc+0x198c>
    3e66:	00002097          	auipc	ra,0x2
    3e6a:	0fe080e7          	jalr	254(ra) # 5f64 <printf>
    exit(1);
    3e6e:	4505                	li	a0,1
    ...
    3e7e:	b5e50513          	addi	a0,a0,-1186 # 79d8 <malloc+0x19bc>
    3e82:	00002097          	auipc	ra,0x2
    3e86:	0e2080e7          	jalr	226(ra) # 5f64 <printf>
    exit(1);
    3e8a:	4505                	li	a0,1
    ...
    3e9a:	b6250513          	addi	a0,a0,-1182 # 79f8 <malloc+0x19dc>
    3e9e:	00002097          	auipc	ra,0x2
    3ea2:	0c6080e7          	jalr	198(ra) # 5f64 <printf>
    exit(1);
    3ea6:	4505                	li	a0,1
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	b5450513          	addi	a0,a0,-1196 # 7a10 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	b4250513          	addi	a0,a0,-1214 # 7a10 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	96050513          	addi	a0,a0,-1696 # 6840 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	57650513          	addi	a0,a0,1398 # 7468 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	50c50513          	addi	a0,a0,1292 # 7410 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	b6250513          	addi	a0,a0,-1182 # 7a78 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	b7850513          	addi	a0,a0,-1160 # 7aa0 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	ad650513          	addi	a0,a0,-1322 # 7a10 <malloc+0x19f4>
    ...
    3f5c:	ac050513          	addi	a0,a0,-1344 # 7a18 <malloc+0x19fc>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	004080e7          	jalr	4(ra) # 5f64 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	abc50513          	addi	a0,a0,-1348 # 7a30 <malloc+0x1a14>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	fe8080e7          	jalr	-24(ra) # 5f64 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ab850513          	addi	a0,a0,-1352 # 7a48 <malloc+0x1a2c>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	fcc080e7          	jalr	-52(ra) # 5f64 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	ab450513          	addi	a0,a0,-1356 # 7a60 <malloc+0x1a44>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	fb0080e7          	jalr	-80(ra) # 5f64 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	45050513          	addi	a0,a0,1104 # 7418 <malloc+0x13fc>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f94080e7          	jalr	-108(ra) # 5f64 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
    ...
    3fe8:	a9c50513          	addi	a0,a0,-1380 # 7a80 <malloc+0x1a64>
    3fec:	00002097          	auipc	ra,0x2
    3ff0:	f78080e7          	jalr	-136(ra) # 5f64 <printf>
    exit(1);
    3ff4:	4505                	li	a0,1
    ...
    4004:	aa850513          	addi	a0,a0,-1368 # 7aa8 <malloc+0x1a8c>
    4008:	00002097          	auipc	ra,0x2
    400c:	f5c080e7          	jalr	-164(ra) # 5f64 <printf>
    exit(1);
    4010:	4505                	li	a0,1
    ...
    4020:	aac50513          	addi	a0,a0,-1364 # 7ac8 <malloc+0x1aac>
    4024:	00002097          	auipc	ra,0x2
    4028:	f40080e7          	jalr	-192(ra) # 5f64 <printf>
    exit(1);
    402c:	4505                	li	a0,1
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	aa050513          	addi	a0,a0,-1376 # 7ae8 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	a8450513          	addi	a0,a0,-1404 # 7ae8 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	ab850513          	addi	a0,a0,-1352 # 7b30 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	aa050513          	addi	a0,a0,-1376 # 7b30 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	a8c50513          	addi	a0,a0,-1396 # 7b30 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	a7850513          	addi	a0,a0,-1416 # 7b30 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	a6458593          	addi	a1,a1,-1436 # 7b30 <malloc+0x1b14>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	25c50513          	addi	a0,a0,604 # 6330 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a0050513          	addi	a0,a0,-1536 # 7ae8 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	74250513          	addi	a0,a0,1858 # 6840 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    4118:	72c50513          	addi	a0,a0,1836 # 6840 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	0a058593          	addi	a1,a1,160 # 61c8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    4158:	99c50513          	addi	a0,a0,-1636 # 7af0 <malloc+0x1ad4>
    415c:	00002097          	auipc	ra,0x2
    4160:	e08080e7          	jalr	-504(ra) # 5f64 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9a050513          	addi	a0,a0,-1632 # 7b10 <malloc+0x1af4>
    4178:	00002097          	auipc	ra,0x2
    417c:	dec080e7          	jalr	-532(ra) # 5f64 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9b450513          	addi	a0,a0,-1612 # 7b40 <malloc+0x1b24>
    4194:	00002097          	auipc	ra,0x2
    4198:	dd0080e7          	jalr	-560(ra) # 5f64 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	99850513          	addi	a0,a0,-1640 # 7b40 <malloc+0x1b24>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	db4080e7          	jalr	-588(ra) # 5f64 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9a450513          	addi	a0,a0,-1628 # 7b68 <malloc+0x1b4c>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d98080e7          	jalr	-616(ra) # 5f64 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9b050513          	addi	a0,a0,-1616 # 7b90 <malloc+0x1b74>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d7c080e7          	jalr	-644(ra) # 5f64 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9bc50513          	addi	a0,a0,-1604 # 7bb8 <malloc+0x1b9c>
    4204:	00002097          	auipc	ra,0x2
    4208:	d60080e7          	jalr	-672(ra) # 5f64 <printf>
    exit(1);
    420c:	4505                	li	a0,1
    ...
    421c:	9c850513          	addi	a0,a0,-1592 # 7be0 <malloc+0x1bc4>
    4220:	00002097          	auipc	ra,0x2
    4224:	d44080e7          	jalr	-700(ra) # 5f64 <printf>
    exit(1);
    4228:	4505                	li	a0,1
    ...
    4238:	9cc50513          	addi	a0,a0,-1588 # 7c00 <malloc+0x1be4>
    423c:	00002097          	auipc	ra,0x2
    4240:	d28080e7          	jalr	-728(ra) # 5f64 <printf>
    exit(1);
    4244:	4505                	li	a0,1
    ...
    4254:	9d850513          	addi	a0,a0,-1576 # 7c28 <malloc+0x1c0c>
    4258:	00002097          	auipc	ra,0x2
    425c:	d0c080e7          	jalr	-756(ra) # 5f64 <printf>
    exit(1);
    4260:	4505                	li	a0,1
...
000000000000426a <iref>:
{
    ...
    4288:	9bca0a13          	addi	s4,s4,-1604 # 7c40 <malloc+0x1c24>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4bc48493          	addi	s1,s1,1212 # 7748 <malloc+0x172c>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	09ca8a93          	addi	s5,s5,156 # 6330 <malloc+0x314>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	89c98993          	addi	s3,s3,-1892 # 7b38 <malloc+0x1b1c>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9a050513          	addi	a0,a0,-1632 # 7c48 <malloc+0x1c2c>
    42b0:	00002097          	auipc	ra,0x2
    42b4:	cb4080e7          	jalr	-844(ra) # 5f64 <printf>
      exit(1);
    42b8:	4505                	li	a0,1
    ...
    42c8:	99c50513          	addi	a0,a0,-1636 # 7c60 <malloc+0x1c44>
    42cc:	00002097          	auipc	ra,0x2
    42d0:	c98080e7          	jalr	-872(ra) # 5f64 <printf>
      exit(1);
    42d4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	11098993          	addi	s3,s3,272 # 7468 <malloc+0x144c>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	8e090913          	addi	s2,s2,-1824 # 7c40 <malloc+0x1c24>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	09050513          	addi	a0,a0,144 # 7410 <malloc+0x13f4>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	8c850513          	addi	a0,a0,-1848 # 7c78 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    43d8:	8a450513          	addi	a0,a0,-1884 # 7c78 <malloc+0x1c5c>
    ...
    43ee:	8ae50513          	addi	a0,a0,-1874 # 7c98 <malloc+0x1c7c>
    43f2:	00002097          	auipc	ra,0x2
    43f6:	b72080e7          	jalr	-1166(ra) # 5f64 <printf>
      exit(1);
    43fa:	4505                	li	a0,1
    ...
    440a:	87a50513          	addi	a0,a0,-1926 # 7c80 <malloc+0x1c64>
    440e:	00002097          	auipc	ra,0x2
    4412:	b56080e7          	jalr	-1194(ra) # 5f64 <printf>
    exit(1);
    4416:	4505                	li	a0,1
    ...
    4426:	5be50513          	addi	a0,a0,1470 # 69e0 <malloc+0x9c4>
    442a:	00002097          	auipc	ra,0x2
    442e:	b3a080e7          	jalr	-1222(ra) # 5f64 <printf>
    exit(1);
    4432:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	82850513          	addi	a0,a0,-2008 # 7c78 <malloc+0x1c5c>
    ...
    4468:	76c50513          	addi	a0,a0,1900 # 6bd0 <malloc+0xbb4>
    446c:	00002097          	auipc	ra,0x2
    4470:	af8080e7          	jalr	-1288(ra) # 5f64 <printf>
    exit(1);
    4474:	4505                	li	a0,1
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	81e50513          	addi	a0,a0,-2018 # 7cc0 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	7f250513          	addi	a0,a0,2034 # 7cc0 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    450a:	69a50513          	addi	a0,a0,1690 # 6ba0 <malloc+0xb84>
    450e:	00002097          	auipc	ra,0x2
    4512:	a56080e7          	jalr	-1450(ra) # 5f64 <printf>
    exit(1);
    4516:	4505                	li	a0,1
    ...
    4524:	7a048493          	addi	s1,s1,1952 # 7cc0 <malloc+0x1ca4>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	77850513          	addi	a0,a0,1912 # 7cc0 <malloc+0x1ca4>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	41250513          	addi	a0,a0,1042 # 69e0 <malloc+0x9c4>
    45d6:	00002097          	auipc	ra,0x2
    45da:	98e080e7          	jalr	-1650(ra) # 5f64 <printf>
      exit(1);
    45de:	4505                	li	a0,1
    ...
    45f8:	6dc50513          	addi	a0,a0,1756 # 7cd0 <malloc+0x1cb4>
    45fc:	00002097          	auipc	ra,0x2
    4600:	968080e7          	jalr	-1688(ra) # 5f64 <printf>
       exit(1);
    4604:	4505                	li	a0,1
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	56c50513          	addi	a0,a0,1388 # 6ba0 <malloc+0xb84>
    463c:	00002097          	auipc	ra,0x2
    4640:	928080e7          	jalr	-1752(ra) # 5f64 <printf>
    exit(1);
    4644:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4666:	37e50513          	addi	a0,a0,894 # 69e0 <malloc+0x9c4>
    466a:	00002097          	auipc	ra,0x2
    466e:	8fa080e7          	jalr	-1798(ra) # 5f64 <printf>
    exit(1);
    4672:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    46aa:	b2258593          	addi	a1,a1,-1246 # 61c8 <malloc+0x1ac>
    ...
    46d4:	31050513          	addi	a0,a0,784 # 69e0 <malloc+0x9c4>
    46d8:	00002097          	auipc	ra,0x2
    46dc:	88c080e7          	jalr	-1908(ra) # 5f64 <printf>
     exit(1);
    46e0:	4505                	li	a0,1
    ...
    46f0:	60450513          	addi	a0,a0,1540 # 7cf0 <malloc+0x1cd4>
    46f4:	00002097          	auipc	ra,0x2
    46f8:	870080e7          	jalr	-1936(ra) # 5f64 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    472c:	5e050513          	addi	a0,a0,1504 # 7d08 <malloc+0x1cec>
    4730:	00002097          	auipc	ra,0x2
    4734:	834080e7          	jalr	-1996(ra) # 5f64 <printf>
}
  ...
  printf("kill... ");
    ...
    4758:	5cc50513          	addi	a0,a0,1484 # 7d20 <malloc+0x1d04>
    475c:	00002097          	auipc	ra,0x2
    4760:	808080e7          	jalr	-2040(ra) # 5f64 <printf>
  kill(pid1);
    4764:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4786:	5ae50513          	addi	a0,a0,1454 # 7d30 <malloc+0x1d14>
    478a:	00001097          	auipc	ra,0x1
    478e:	7da080e7          	jalr	2010(ra) # 5f64 <printf>
  wait(0);
    4792:	4501                	li	a0,0
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	1de50513          	addi	a0,a0,478 # 69e0 <malloc+0x9c4>
    480a:	00001097          	auipc	ra,0x1
    480e:	75a080e7          	jalr	1882(ra) # 5f64 <printf>
      exit(1);
    4812:	4505                	li	a0,1
    ...
    4822:	34a50513          	addi	a0,a0,842 # 6b68 <malloc+0xb4c>
    4826:	00001097          	auipc	ra,0x1
    482a:	73e080e7          	jalr	1854(ra) # 5f64 <printf>
        exit(1);
    482e:	4505                	li	a0,1
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	25450513          	addi	a0,a0,596 # 6ae8 <malloc+0xacc>
    489c:	00001097          	auipc	ra,0x1
    48a0:	6c8080e7          	jalr	1736(ra) # 5f64 <printf>
    exit(1);
    48a4:	4505                	li	a0,1
    ...
    48cc:	90058593          	addi	a1,a1,-1792 # 61c8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	3b450513          	addi	a0,a0,948 # 7d40 <malloc+0x1d24>
    4994:	00001097          	auipc	ra,0x1
    4998:	5d0080e7          	jalr	1488(ra) # 5f64 <printf>
    exit(1);
    499c:	4505                	li	a0,1
    ...
    49ac:	03850513          	addi	a0,a0,56 # 69e0 <malloc+0x9c4>
    49b0:	00001097          	auipc	ra,0x1
    49b4:	5b4080e7          	jalr	1460(ra) # 5f64 <printf>
    exit(1);
    49b8:	4505                	li	a0,1
    ...
    49f8:	36c50513          	addi	a0,a0,876 # 7d60 <malloc+0x1d44>
    49fc:	00001097          	auipc	ra,0x1
    4a00:	568080e7          	jalr	1384(ra) # 5f64 <printf>
    exit(1);
    4a04:	4505                	li	a0,1
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a62:	5be080e7          	jalr	1470(ra) # 601c <malloc>
    ...
    4a9c:	2f850513          	addi	a0,a0,760 # 7d90 <malloc+0x1d74>
    4aa0:	00001097          	auipc	ra,0x1
    4aa4:	4c4080e7          	jalr	1220(ra) # 5f64 <printf>
      exit(1);
    4aa8:	4505                	li	a0,1
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	26650513          	addi	a0,a0,614 # 7dc0 <malloc+0x1da4>
    4b62:	00001097          	auipc	ra,0x1
    4b66:	402080e7          	jalr	1026(ra) # 5f64 <printf>
    exit(1);
    4b6a:	4505                	li	a0,1
    ...
    4b7a:	27250513          	addi	a0,a0,626 # 7de8 <malloc+0x1dcc>
    4b7e:	00001097          	auipc	ra,0x1
    4b82:	3e6080e7          	jalr	998(ra) # 5f64 <printf>
      exit(1);
    4b86:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	1f650513          	addi	a0,a0,502 # 7db0 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	20e50513          	addi	a0,a0,526 # 7e08 <malloc+0x1dec>
    4c02:	00001097          	auipc	ra,0x1
    4c06:	362080e7          	jalr	866(ra) # 5f64 <printf>
    exit(1);
    4c0a:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4c3a:	17a50513          	addi	a0,a0,378 # 7db0 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	1d450513          	addi	a0,a0,468 # 7e30 <malloc+0x1e14>
    4c64:	00001097          	auipc	ra,0x1
    4c68:	300080e7          	jalr	768(ra) # 5f64 <printf>
    exit(1);
    4c6c:	4505                	li	a0,1
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	1a878793          	addi	a5,a5,424 # 7e48 <malloc+0x1e2c>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1a478793          	addi	a5,a5,420 # 7e50 <malloc+0x1e34>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1a078793          	addi	a5,a5,416 # 7e58 <malloc+0x1e3c>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	19c78793          	addi	a5,a5,412 # 7e60 <malloc+0x1e44>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	0b650513          	addi	a0,a0,182 # 6de8 <malloc+0xdcc>
    4d3a:	00001097          	auipc	ra,0x1
    4d3e:	22a080e7          	jalr	554(ra) # 5f64 <printf>
      exit(1);
    4d42:	4505                	li	a0,1
    ...
    4db0:	0bc50513          	addi	a0,a0,188 # 7e68 <malloc+0x1e4c>
    4db4:	00001097          	auipc	ra,0x1
    4db8:	1b0080e7          	jalr	432(ra) # 5f64 <printf>
        exit(1);
    4dbc:	4505                	li	a0,1
    ...
    4dca:	0b250513          	addi	a0,a0,178 # 7e78 <malloc+0x1e5c>
    4dce:	00001097          	auipc	ra,0x1
    4dd2:	196080e7          	jalr	406(ra) # 5f64 <printf>
          exit(1);
    4dd6:	4505                	li	a0,1
    ...
    4df0:	0a450513          	addi	a0,a0,164 # 7e90 <malloc+0x1e74>
    4df4:	00001097          	auipc	ra,0x1
    4df8:	170080e7          	jalr	368(ra) # 5f64 <printf>
          exit(1);
    4dfc:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	02c50513          	addi	a0,a0,44 # 7ea0 <malloc+0x1e84>
    4e7c:	00001097          	auipc	ra,0x1
    4e80:	0e8080e7          	jalr	232(ra) # 5f64 <printf>
      exit(1);
    4e84:	4505                	li	a0,1
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	fe2b8b93          	addi	s7,s7,-30 # 7eb8 <malloc+0x1e9c>
  for(i = 0; i < N; i++){
    ...
    4f1c:	fa850513          	addi	a0,a0,-88 # 7ec0 <malloc+0x1ea4>
    4f20:	00001097          	auipc	ra,0x1
    4f24:	044080e7          	jalr	68(ra) # 5f64 <printf>
        exit(1);
    4f28:	4505                	li	a0,1
    ...
    4f3a:	f8250513          	addi	a0,a0,-126 # 7eb8 <malloc+0x1e9c>
  ...
  fd = open(".", 0);
    ...
    4f72:	8d250513          	addi	a0,a0,-1838 # 6840 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	efa50513          	addi	a0,a0,-262 # 7ee0 <malloc+0x1ec4>
    4fee:	00001097          	auipc	ra,0x1
    4ff2:	f76080e7          	jalr	-138(ra) # 5f64 <printf>
        exit(1);
    4ff6:	4505                	li	a0,1
    ...
    500a:	efa50513          	addi	a0,a0,-262 # 7f00 <malloc+0x1ee4>
    500e:	00001097          	auipc	ra,0x1
    5012:	f56080e7          	jalr	-170(ra) # 5f64 <printf>
        exit(1);
    5016:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	eea50513          	addi	a0,a0,-278 # 7f28 <malloc+0x1f0c>
    5046:	00001097          	auipc	ra,0x1
    504a:	f1e080e7          	jalr	-226(ra) # 5f64 <printf>
    exit(1);
    504e:	4505                	li	a0,1
    ...
    505e:	98650513          	addi	a0,a0,-1658 # 69e0 <malloc+0x9c4>
    5062:	00001097          	auipc	ra,0x1
    5066:	f02080e7          	jalr	-254(ra) # 5f64 <printf>
      exit(1);
    506a:	4505                	li	a0,1
...
0000000000005208 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	cd450513          	addi	a0,a0,-812 # 7f60 <malloc+0x1f44>
  ...
  for(i = 0; ; i++){
    ...
    52f4:	c8050513          	addi	a0,a0,-896 # 7f70 <malloc+0x1f54>
    52f8:	00001097          	auipc	ra,0x1
    52fc:	c6c080e7          	jalr	-916(ra) # 5f64 <printf>
    exit(1);
    5300:	4505                	li	a0,1
    ...
    5310:	c8450513          	addi	a0,a0,-892 # 7f90 <malloc+0x1f74>
    5314:	00001097          	auipc	ra,0x1
    5318:	c50080e7          	jalr	-944(ra) # 5f64 <printf>
      exit(1);
    531c:	4505                	li	a0,1
    ...
    532c:	c8850513          	addi	a0,a0,-888 # 7fb0 <malloc+0x1f94>
    5330:	00001097          	auipc	ra,0x1
    5334:	c34080e7          	jalr	-972(ra) # 5f64 <printf>
    exit(1);
    5338:	4505                	li	a0,1
    ...
    5348:	c8c50513          	addi	a0,a0,-884 # 7fd0 <malloc+0x1fb4>
    534c:	00001097          	auipc	ra,0x1
    5350:	c18080e7          	jalr	-1000(ra) # 5f64 <printf>
      exit(1);
    5354:	4505                	li	a0,1
    ...
    5364:	c9050513          	addi	a0,a0,-880 # 7ff0 <malloc+0x1fd4>
    5368:	00001097          	auipc	ra,0x1
    536c:	bfc080e7          	jalr	-1028(ra) # 5f64 <printf>
      exit(1);
    5370:	4505                	li	a0,1
    ...
    5380:	c8c50513          	addi	a0,a0,-884 # 8008 <malloc+0x1fec>
    5384:	00001097          	auipc	ra,0x1
    5388:	be0080e7          	jalr	-1056(ra) # 5f64 <printf>
      exit(1);
    538c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    53ae:	bb650513          	addi	a0,a0,-1098 # 7f60 <malloc+0x1f44>
    ...
    53d2:	c5a50513          	addi	a0,a0,-934 # 8028 <malloc+0x200c>
    53d6:	00001097          	auipc	ra,0x1
    53da:	b8e080e7          	jalr	-1138(ra) # 5f64 <printf>
    exit(1);
    53de:	4505                	li	a0,1
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	c4450513          	addi	a0,a0,-956 # 8048 <malloc+0x202c>
    540c:	00001097          	auipc	ra,0x1
    5410:	b58080e7          	jalr	-1192(ra) # 5f64 <printf>
  for(nfiles = 0; ; nfiles++){
    5414:	4481                	li	s1,0
    name[0] = 'f';
    ...
    5428:	c34c8c93          	addi	s9,s9,-972 # 8058 <malloc+0x203c>
    name[0] = 'f';
    ...
    5476:	af2080e7          	jalr	-1294(ra) # 5f64 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5498:	bd450513          	addi	a0,a0,-1068 # 8068 <malloc+0x204c>
    549c:	00001097          	auipc	ra,0x1
    54a0:	ac8080e7          	jalr	-1336(ra) # 5f64 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    550e:	b7e50513          	addi	a0,a0,-1154 # 8088 <malloc+0x206c>
    5512:	00001097          	auipc	ra,0x1
    5516:	a52080e7          	jalr	-1454(ra) # 5f64 <printf>
}
    ...
    5564:	b1850513          	addi	a0,a0,-1256 # 8078 <malloc+0x205c>
    5568:	00001097          	auipc	ra,0x1
    556c:	9fc080e7          	jalr	-1540(ra) # 5f64 <printf>
    close(fd);
    5570:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b0e50513          	addi	a0,a0,-1266 # 80a0 <malloc+0x2084>
    559a:	00001097          	auipc	ra,0x1
    559e:	9ca080e7          	jalr	-1590(ra) # 5f64 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55c6:	b0650513          	addi	a0,a0,-1274 # 80c8 <malloc+0x20ac>
    55ca:	00001097          	auipc	ra,0x1
    55ce:	99a080e7          	jalr	-1638(ra) # 5f64 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55ea:	aca50513          	addi	a0,a0,-1334 # 80b0 <malloc+0x2094>
    55ee:	00001097          	auipc	ra,0x1
    55f2:	976080e7          	jalr	-1674(ra) # 5f64 <printf>
    exit(1);
    55f6:	4505                	li	a0,1
    ...
    5612:	ac250513          	addi	a0,a0,-1342 # 80d0 <malloc+0x20b4>
    5616:	00001097          	auipc	ra,0x1
    561a:	94e080e7          	jalr	-1714(ra) # 5f64 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	a7a50513          	addi	a0,a0,-1414 # 80d8 <malloc+0x20bc>
    5666:	00001097          	auipc	ra,0x1
    566a:	8fe080e7          	jalr	-1794(ra) # 5f64 <printf>
        return 1;
    566e:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	b1098993          	addi	s3,s3,-1264 # 61c8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	a4650513          	addi	a0,a0,-1466 # 8130 <malloc+0x2114>
    56f2:	00001097          	auipc	ra,0x1
    56f6:	872080e7          	jalr	-1934(ra) # 5f64 <printf>
        exit(1);
    56fa:	4505                	li	a0,1
    ...
    570e:	9e650513          	addi	a0,a0,-1562 # 80f0 <malloc+0x20d4>
    5712:	00001097          	auipc	ra,0x1
    5716:	852080e7          	jalr	-1966(ra) # 5f64 <printf>
    exit(1);
    571a:	4505                	li	a0,1
    ...
    572e:	9e650513          	addi	a0,a0,-1562 # 8110 <malloc+0x20f4>
    5732:	00001097          	auipc	ra,0x1
    5736:	832080e7          	jalr	-1998(ra) # 5f64 <printf>
    exit(1);
    573a:	4505                	li	a0,1
  ...
  while(1){
    ...
    5782:	9d250513          	addi	a0,a0,-1582 # 8150 <malloc+0x2134>
    5786:	00000097          	auipc	ra,0x0
    578a:	7de080e7          	jalr	2014(ra) # 5f64 <printf>
      exit(1);
    578e:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	994b8b93          	addi	s7,s7,-1644 # 8170 <malloc+0x2154>
    int free0 = countfree();
    int free1 = 0;
    ...
    57fa:	992d0d13          	addi	s10,s10,-1646 # 8188 <malloc+0x216c>
          return 1;
        }
      }
    }
    ...
    5802:	9aac8c93          	addi	s9,s9,-1622 # 81a8 <malloc+0x218c>
    5806:	a839                	j	5824 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    5808:	856a                	mv	a0,s10
    580a:	00000097          	auipc	ra,0x0
    580e:	75a080e7          	jalr	1882(ra) # 5f64 <printf>
    ...
    582a:	73e080e7          	jalr	1854(ra) # 5f64 <printf>
    int free0 = countfree();
    ...
    5872:	6f6080e7          	jalr	1782(ra) # 5f64 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	90258593          	addi	a1,a1,-1790 # 81d8 <malloc+0x21bc>
  ...
  char *justone = 0;
    ...
    58f8:	8ec58593          	addi	a1,a1,-1812 # 81e0 <malloc+0x21c4>
    ...
    590e:	92658593          	addi	a1,a1,-1754 # 8230 <malloc+0x2214>
  ...
  int continuous = 0;
    ...
    593a:	8b250513          	addi	a0,a0,-1870 # 81e8 <malloc+0x21cc>
    593e:	00000097          	auipc	ra,0x0
    5942:	626080e7          	jalr	1574(ra) # 5f64 <printf>
    exit(1);
    5946:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	8bc50513          	addi	a0,a0,-1860 # 8218 <malloc+0x21fc>
    5964:	00000097          	auipc	ra,0x0
    5968:	600080e7          	jalr	1536(ra) # 5f64 <printf>
  exit(0);
    596c:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c9c:	1101                	addi	sp,sp,-32
    5c9e:	ec06                	sd	ra,24(sp)
    5ca0:	e822                	sd	s0,16(sp)
    5ca2:	1000                	addi	s0,sp,32
    5ca4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5ca8:	4605                	li	a2,1
    5caa:	fef40593          	addi	a1,s0,-17
    5cae:	00000097          	auipc	ra,0x0
    5cb2:	f6e080e7          	jalr	-146(ra) # 5c1c <write>
}
    5cb6:	60e2                	ld	ra,24(sp)
    5cb8:	6442                	ld	s0,16(sp)
    5cba:	6105                	addi	sp,sp,32
    5cbc:	8082                	ret

0000000000005cbe <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5cbe:	7139                	addi	sp,sp,-64
    5cc0:	fc06                	sd	ra,56(sp)
    5cc2:	f822                	sd	s0,48(sp)
    5cc4:	f426                	sd	s1,40(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5cca:	c299                	beqz	a3,5cd0 <printint+0x12>
    5ccc:	0805cb63          	bltz	a1,5d62 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5ce0:	91c50513          	addi	a0,a0,-1764 # 85f8 <digits>
    5ce4:	883a                	mv	a6,a4
    ...
    5d04:	fec7f0e3          	bgeu	a5,a2,5ce4 <printint+0x26>
  if(neg)
    5d08:	00088c63          	beqz	a7,5d20 <printint+0x62>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    5d20:	02e05c63          	blez	a4,5d58 <printint+0x9a>
    5d24:	f04a                	sd	s2,32(sp)
    5d26:	ec4e                	sd	s3,24(sp)
    ...
    5d4a:	f56080e7          	jalr	-170(ra) # 5c9c <putc>
  while(--i >= 0)
    5d4e:	197d                	addi	s2,s2,-1
    5d50:	ff3918e3          	bne	s2,s3,5d40 <printint+0x82>
    ...
    5d66:	4885                	li	a7,1
    x = -xx;
    5d68:	b7b5                	j	5cd4 <printint+0x16>
...
{
    5d6a:	715d                	addi	sp,sp,-80
    5d6c:	e486                	sd	ra,72(sp)
    5d6e:	e0a2                	sd	s0,64(sp)
    5d70:	f84a                	sd	s2,48(sp)
    5d72:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d78:	1a090a63          	beqz	s2,5f2c <vprintf+0x1c2>
    5d7c:	fc26                	sd	s1,56(sp)
    5d7e:	f44e                	sd	s3,40(sp)
    5d80:	f052                	sd	s4,32(sp)
    5d82:	ec56                	sd	s5,24(sp)
    5d84:	e85a                	sd	s6,16(sp)
    5d86:	e45e                	sd	s7,8(sp)
    5d88:	8aaa                	mv	s5,a0
    5d8a:	8bb2                	mv	s7,a2
  ...
  state = 0;
    ...
    5d96:	4b55                	li	s6,21
    5d98:	a839                	j	5db6 <vprintf+0x4c>
        putc(fd, c);
    5d9a:	85ca                	mv	a1,s2
    5d9c:	8556                	mv	a0,s5
    5d9e:	00000097          	auipc	ra,0x0
    5da2:	efe080e7          	jalr	-258(ra) # 5c9c <putc>
    5da6:	a019                	j	5dac <vprintf+0x42>
    } else if(state == '%'){
    5da8:	01498d63          	beq	s3,s4,5dc2 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    5dac:	0485                	addi	s1,s1,1
    5dae:	fff4c903          	lbu	s2,-1(s1)
    5db2:	16090763          	beqz	s2,5f20 <vprintf+0x1b6>
    if(state == 0){
    5db6:	fe0999e3          	bnez	s3,5da8 <vprintf+0x3e>
      if(c == '%'){
    5dba:	ff4910e3          	bne	s2,s4,5d9a <vprintf+0x30>
        state = '%';
    5dbe:	89d2                	mv	s3,s4
    5dc0:	b7f5                	j	5dac <vprintf+0x42>
      if(c == 'd'){
    5dc2:	13490463          	beq	s2,s4,5eea <vprintf+0x180>
    5dc6:	f9d9079b          	addiw	a5,s2,-99
    5dca:	0ff7f793          	zext.b	a5,a5
    5dce:	12fb6763          	bltu	s6,a5,5efc <vprintf+0x192>
    5dd2:	f9d9079b          	addiw	a5,s2,-99
    5dd6:	0ff7f713          	zext.b	a4,a5
    5dda:	12eb6163          	bltu	s6,a4,5efc <vprintf+0x192>
    5dde:	00271793          	slli	a5,a4,0x2
    5de2:	00002717          	auipc	a4,0x2
    5de6:	7be70713          	addi	a4,a4,1982 # 85a0 <malloc+0x2584>
    5dea:	97ba                	add	a5,a5,a4
    5dec:	439c                	lw	a5,0(a5)
    5dee:	97ba                	add	a5,a5,a4
    5df0:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5df2:	008b8913          	addi	s2,s7,8
    5df6:	4685                	li	a3,1
    5df8:	4629                	li	a2,10
    5dfa:	000ba583          	lw	a1,0(s7)
    5dfe:	8556                	mv	a0,s5
    5e00:	00000097          	auipc	ra,0x0
    5e04:	ebe080e7          	jalr	-322(ra) # 5cbe <printint>
    5e08:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5e0a:	4981                	li	s3,0
    5e0c:	b745                	j	5dac <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5e0e:	008b8913          	addi	s2,s7,8
    5e12:	4681                	li	a3,0
    5e14:	4629                	li	a2,10
    5e16:	000ba583          	lw	a1,0(s7)
    5e1a:	8556                	mv	a0,s5
    5e1c:	00000097          	auipc	ra,0x0
    5e20:	ea2080e7          	jalr	-350(ra) # 5cbe <printint>
    5e24:	8bca                	mv	s7,s2
      state = 0;
    5e26:	4981                	li	s3,0
    5e28:	b751                	j	5dac <vprintf+0x42>
        printint(fd, va_arg(ap, int), 16, 0);
    5e2a:	008b8913          	addi	s2,s7,8
    5e2e:	4681                	li	a3,0
    5e30:	4641                	li	a2,16
    5e32:	000ba583          	lw	a1,0(s7)
    5e36:	8556                	mv	a0,s5
    5e38:	00000097          	auipc	ra,0x0
    5e3c:	e86080e7          	jalr	-378(ra) # 5cbe <printint>
    5e40:	8bca                	mv	s7,s2
      state = 0;
    5e42:	4981                	li	s3,0
    5e44:	b7a5                	j	5dac <vprintf+0x42>
    5e46:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5e48:	008b8c13          	addi	s8,s7,8
    5e4c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5e50:	03000593          	li	a1,48
    5e54:	8556                	mv	a0,s5
    5e56:	00000097          	auipc	ra,0x0
    5e5a:	e46080e7          	jalr	-442(ra) # 5c9c <putc>
  putc(fd, 'x');
    5e5e:	07800593          	li	a1,120
    5e62:	8556                	mv	a0,s5
    5e64:	00000097          	auipc	ra,0x0
    5e68:	e38080e7          	jalr	-456(ra) # 5c9c <putc>
    5e6c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e6e:	00002b97          	auipc	s7,0x2
    5e72:	78ab8b93          	addi	s7,s7,1930 # 85f8 <digits>
    5e76:	03c9d793          	srli	a5,s3,0x3c
    5e7a:	97de                	add	a5,a5,s7
    5e7c:	0007c583          	lbu	a1,0(a5)
    5e80:	8556                	mv	a0,s5
    5e82:	00000097          	auipc	ra,0x0
    5e86:	e1a080e7          	jalr	-486(ra) # 5c9c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e8a:	0992                	slli	s3,s3,0x4
    5e8c:	397d                	addiw	s2,s2,-1
    5e8e:	fe0914e3          	bnez	s2,5e76 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5e92:	8be2                	mv	s7,s8
      state = 0;
    5e94:	4981                	li	s3,0
    5e96:	6c02                	ld	s8,0(sp)
    5e98:	bf11                	j	5dac <vprintf+0x42>
        s = va_arg(ap, char*);
    5e9a:	008b8993          	addi	s3,s7,8
    5e9e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5ea2:	02090163          	beqz	s2,5ec4 <vprintf+0x15a>
        while(*s != 0){
    5ea6:	00094583          	lbu	a1,0(s2)
    5eaa:	c9a5                	beqz	a1,5f1a <vprintf+0x1b0>
          putc(fd, *s);
    5eac:	8556                	mv	a0,s5
    5eae:	00000097          	auipc	ra,0x0
    5eb2:	dee080e7          	jalr	-530(ra) # 5c9c <putc>
          s++;
    5eb6:	0905                	addi	s2,s2,1
        while(*s != 0){
    5eb8:	00094583          	lbu	a1,0(s2)
    5ebc:	f9e5                	bnez	a1,5eac <vprintf+0x142>
        s = va_arg(ap, char*);
    5ebe:	8bce                	mv	s7,s3
      state = 0;
    5ec0:	4981                	li	s3,0
    5ec2:	b5ed                	j	5dac <vprintf+0x42>
          s = "(null)";
    5ec4:	00002917          	auipc	s2,0x2
    5ec8:	6b490913          	addi	s2,s2,1716 # 8578 <malloc+0x255c>
        while(*s != 0){
    5ecc:	02800593          	li	a1,40
    5ed0:	bff1                	j	5eac <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5ed2:	008b8913          	addi	s2,s7,8
    5ed6:	000bc583          	lbu	a1,0(s7)
    5eda:	8556                	mv	a0,s5
    5edc:	00000097          	auipc	ra,0x0
    5ee0:	dc0080e7          	jalr	-576(ra) # 5c9c <putc>
    5ee4:	8bca                	mv	s7,s2
      state = 0;
    5ee6:	4981                	li	s3,0
    5ee8:	b5d1                	j	5dac <vprintf+0x42>
        putc(fd, c);
    5eea:	02500593          	li	a1,37
    5eee:	8556                	mv	a0,s5
    5ef0:	00000097          	auipc	ra,0x0
    5ef4:	dac080e7          	jalr	-596(ra) # 5c9c <putc>
      state = 0;
    5ef8:	4981                	li	s3,0
    5efa:	bd4d                	j	5dac <vprintf+0x42>
        putc(fd, '%');
    5efc:	02500593          	li	a1,37
    5f00:	8556                	mv	a0,s5
    5f02:	00000097          	auipc	ra,0x0
    5f06:	d9a080e7          	jalr	-614(ra) # 5c9c <putc>
        putc(fd, c);
    5f0a:	85ca                	mv	a1,s2
    5f0c:	8556                	mv	a0,s5
    5f0e:	00000097          	auipc	ra,0x0
    5f12:	d8e080e7          	jalr	-626(ra) # 5c9c <putc>
      state = 0;
    5f16:	4981                	li	s3,0
    5f18:	bd51                	j	5dac <vprintf+0x42>
        s = va_arg(ap, char*);
    5f1a:	8bce                	mv	s7,s3
      state = 0;
    5f1c:	4981                	li	s3,0
    5f1e:	b579                	j	5dac <vprintf+0x42>
    5f20:	74e2                	ld	s1,56(sp)
    5f22:	79a2                	ld	s3,40(sp)
    5f24:	7a02                	ld	s4,32(sp)
    5f26:	6ae2                	ld	s5,24(sp)
    5f28:	6b42                	ld	s6,16(sp)
    5f2a:	6ba2                	ld	s7,8(sp)
    }
  }
}
    5f2c:	60a6                	ld	ra,72(sp)
    5f2e:	6406                	ld	s0,64(sp)
    5f30:	7942                	ld	s2,48(sp)
    5f32:	6161                	addi	sp,sp,80
    5f34:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    5f58:	e16080e7          	jalr	-490(ra) # 5d6a <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    5f8e:	de0080e7          	jalr	-544(ra) # 5d6a <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5fac:	a02d                	j	5fd6 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fae:	4618                	lw	a4,8(a2)
    5fb0:	9f2d                	addw	a4,a4,a1
    5fb2:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fb6:	6398                	ld	a4,0(a5)
    5fb8:	6310                	ld	a2,0(a4)
    5fba:	a83d                	j	5ff8 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fbc:	ff852703          	lw	a4,-8(a0)
    5fc0:	9f31                	addw	a4,a4,a2
    5fc2:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fc4:	ff053683          	ld	a3,-16(a0)
    5fc8:	a091                	j	600c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fca:	6398                	ld	a4,0(a5)
    5fcc:	00e7e463          	bltu	a5,a4,5fd4 <free+0x3a>
    5fd0:	00e6ea63          	bltu	a3,a4,5fe4 <free+0x4a>
{
    5fd4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fd6:	fed7fae3          	bgeu	a5,a3,5fca <free+0x30>
    5fda:	6398                	ld	a4,0(a5)
    5fdc:	00e6e463          	bltu	a3,a4,5fe4 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fe0:	fee7eae3          	bltu	a5,a4,5fd4 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5fe4:	ff852583          	lw	a1,-8(a0)
    5fe8:	6390                	ld	a2,0(a5)
    5fea:	02059813          	slli	a6,a1,0x20
    5fee:	01c85713          	srli	a4,a6,0x1c
    5ff2:	9736                	add	a4,a4,a3
    5ff4:	fae60de3          	beq	a2,a4,5fae <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5ff8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5ffc:	4790                	lw	a2,8(a5)
    5ffe:	02061593          	slli	a1,a2,0x20
    6002:	01c5d713          	srli	a4,a1,0x1c
    6006:	973e                	add	a4,a4,a5
    6008:	fae68ae3          	beq	a3,a4,5fbc <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    603c:	41853503          	ld	a0,1048(a0) # 9450 <freep>
    6040:	c915                	beqz	a0,6074 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    6046:	08977e63          	bgeu	a4,s1,60e2 <malloc+0xc6>
    604a:	f04a                	sd	s2,32(sp)
    604c:	e852                	sd	s4,16(sp)
    604e:	e456                	sd	s5,8(sp)
    6050:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    6052:	8a4e                	mv	s4,s3
  ...
  if(p == (char*)-1)
    6070:	5afd                	li	s5,-1
    6072:	a091                	j	60b6 <malloc+0x9a>
    6074:	f04a                	sd	s2,32(sp)
    6076:	e852                	sd	s4,16(sp)
    6078:	e456                	sd	s5,8(sp)
    607a:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    ...
    if(p->s.size >= nunits){
    6092:	b7c1                	j	6052 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    6094:	6398                	ld	a4,0(a5)
    6096:	e118                	sd	a4,0(a0)
    6098:	a08d                	j	60fa <malloc+0xde>
  hp->s.size = nu;
    609a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    609e:	0541                	addi	a0,a0,16
    60a0:	00000097          	auipc	ra,0x0
    60a4:	efa080e7          	jalr	-262(ra) # 5f9a <free>
  return freep;
    60a8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60ac:	c13d                	beqz	a0,6112 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60ae:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60b0:	4798                	lw	a4,8(a5)
    60b2:	02977463          	bgeu	a4,s1,60da <malloc+0xbe>
    if(p == freep)
    60b6:	00093703          	ld	a4,0(s2)
    60ba:	853e                	mv	a0,a5
    60bc:	fef719e3          	bne	a4,a5,60ae <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    60c0:	8552                	mv	a0,s4
    60c2:	00000097          	auipc	ra,0x0
    60c6:	bc2080e7          	jalr	-1086(ra) # 5c84 <sbrk>
  if(p == (char*)-1)
    60ca:	fd5518e3          	bne	a0,s5,609a <malloc+0x7e>
        return 0;
    60ce:	4501                	li	a0,0
    60d0:	7902                	ld	s2,32(sp)
    60d2:	6a42                	ld	s4,16(sp)
    60d4:	6aa2                	ld	s5,8(sp)
    60d6:	6b02                	ld	s6,0(sp)
    60d8:	a03d                	j	6106 <malloc+0xea>
    60da:	7902                	ld	s2,32(sp)
    60dc:	6a42                	ld	s4,16(sp)
    60de:	6aa2                	ld	s5,8(sp)
    60e0:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    60e2:	fae489e3          	beq	s1,a4,6094 <malloc+0x78>
        p->s.size -= nunits;
    60e6:	4137073b          	subw	a4,a4,s3
    60ea:	c798                	sw	a4,8(a5)
        p += p->s.size;
    60ec:	02071693          	slli	a3,a4,0x20
    60f0:	01c6d713          	srli	a4,a3,0x1c
